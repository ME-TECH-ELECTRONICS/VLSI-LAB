...
while True:
        ...
        print("3. Calculate the area of square")
        print("Press enter Exit program")
        option: int = int(input("Choose an option: "))
        if(option == 1):
            rad: float = float(input("Enter the radius: "))
            print(f"Area of circle of radius {rad} is {calcCircleArea(rad):.2f}")
        elif option == 2:
            length: float = float(input("Enter the length: "))
            breadth: float = float(input("Enter the breadth: "))
            print(f"Area of rectangle of length {length}, breadth {breadth} is {calcRectArea(length, breadth):.2f}")
        elif option == 3:
            side: float = float(input("Enter the side: "))
            print(f"Area of square of side {side} is {calcSquareArea(side):.2f}") 
        else:
